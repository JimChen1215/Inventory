...
namespace Verdun.Enterprise.Inventory.Models
{
    public class InventoryService : IInventoryService
    {
        ...
        public InventoryService(AppDbContext context, ILogger<AssetService> logger, IHttpContextAccessor httpContextAccessor)
        {
            _logger = logger;
        ...
        {
            IList<InvAssetType> assetTypes = _context.InvAssetType.ToList();
        ...
        {
            List<AssetTypeAttributeViewModel> result = new List<AssetTypeAttributeViewModel>();
